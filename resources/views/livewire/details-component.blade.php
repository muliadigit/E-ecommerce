    ...
    <div class="row">
                ...
                <div class="detail-info">
                    ...
                    @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now()) 
                        <div class="wrap-price">
                            <span class="product-price">Rp {{number_format($product->sale_price)}}</span>
                            <del><span class="product-price regprice">Rp {{number_format($product->regular_price)}}</span></del>
                        </div>
                    @else
                        <div class="wrap-price"><span class="product-price">Rp {{number_format($product->regular_price)}}</span></div>
                    @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
            ...
            <div class="widget mercado-widget widget-product">
                ...
                <div class="widget-content">
                    <ul class="products">
                        @foreach ($populer_products as $p_product)
